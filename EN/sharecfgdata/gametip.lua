{
  ...
  build_ship_quickly_buy_stone = {
    tip = "Spend<color=#92fc63><icon name=diamond w=0.7 h=0.7/>$1</color>Gems to buy<color=$3>$2</color>个$4"
  },
